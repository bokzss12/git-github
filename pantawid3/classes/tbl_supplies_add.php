 ...
 * Page class
 */
class tbl_supplies_add extends tbl_supplies
{
	...
	// Page object name
	public $PageObjName = "tbl_supplies_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "tbl_suppliesview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->supplies_cat->CurrentValue = NULL;
		$this->supplies_cat->OldValue = $this->supplies_cat->CurrentValue;
		...
		$this->date_consumed->CurrentValue = NULL;
		$this->date_consumed->OldValue = $this->date_consumed->CurrentValue;
		...
		$this->user_date_modify->CurrentValue = NULL;
		$this->user_date_modify->OldValue = $this->user_date_modify->CurrentValue;
	}
	...
	protected function newRow()
	{
		...
		$row['supplies_cat'] = $this->supplies_cat->CurrentValue;
		...
		$row['date_consumed'] = $this->date_consumed->CurrentValue;
		...
		$row['user_date_modify'] = $this->user_date_modify->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// supplies_cat
		$this->supplies_cat->setDbValueDef($rsnew, $this->supplies_cat->CurrentValue, NULL, FALSE);

		// model
		$this->model->setDbValueDef($rsnew, $this->model->CurrentValue, NULL, FALSE);

		// serial
		$this->serial->setDbValueDef($rsnew, $this->serial->CurrentValue, NULL, FALSE);
		...
		// date_consumed
		$this->date_consumed->setDbValueDef($rsnew, UnFormatDateTime($this->date_consumed->CurrentValue, 0), NULL, FALSE);
