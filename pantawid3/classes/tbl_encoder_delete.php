 ...
 * Page class
 */
class tbl_encoder_delete extends tbl_encoder
{
	...
	// Page object name
	public $PageObjName = "tbl_encoder_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_encoderlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("tbl_encoderlist.php"); // Return to list
				return;
			}
		}
