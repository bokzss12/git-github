 ...
 * Page class
 */
class tbl_supplies_delete extends tbl_supplies
{
	...
	// Page object name
	public $PageObjName = "tbl_supplies_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_supplieslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tbl_supplieslist.php"); // Return to list
			}
		}
	}
