...
class Dashboard1_dashboard extends ReportTable
{
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS['for_charting2']))
			$GLOBALS['for_charting2'] = new for_charting2();

		// Table object (inventory_chart2)
		if (!isset($GLOBALS['inventory_chart2']))
			$GLOBALS['inventory_chart2'] = new inventory_chart2();
	...
	public $ItemClassNames = ["col-sm-1","col-sm-1","col-sm-1","col-sm-1","col-sm-1","col-sm-1","col-sm-1","col-sm-1","col-sm-4"];
