 ...
 * Page class
 */
class tbl_pr_delete extends tbl_pr
{
	...
	// Page object name
	public $PageObjName = "tbl_pr_delete";
	...
	public function run()
	{
		...
		$this->date_delivered->Visible = FALSE;
		...
		if ($filter == "") {
			$this->terminate("tbl_prlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tbl_prlist.php"); // Return to list
			}
		}
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			// purpose
			$this->purpose->ViewValue = TruncateMemo($this->purpose->CurrentValue, 30, $this->purpose->TruncateMemoRemoveHtml);
