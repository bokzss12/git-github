 ...
 * Page class
 */
class tbl_repair_status_view extends tbl_repair_status
{
	...
	// Page object name
	public $PageObjName = "tbl_repair_status_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("repair_id") !== NULL) {
				...
				$returnUrl = "tbl_repair_statuslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_repair_statuslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tbl_repair_statuslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
