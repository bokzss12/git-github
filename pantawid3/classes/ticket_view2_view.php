 ...
 * Page class
 */
class ticket_view2_view extends ticket_view2
{
	...
	// Page object name
	public $PageObjName = "ticket_view2_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("item_id") !== NULL) {
				...
				$returnUrl = "ticket_view2list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "ticket_view2list.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "ticket_view2list.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
