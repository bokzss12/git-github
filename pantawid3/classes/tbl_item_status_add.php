 ...
 * Page class
 */
class tbl_item_status_add extends tbl_item_status
{
	...
	// Page object name
	public $PageObjName = "tbl_item_status_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "tbl_item_statusview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// status_desc
		$this->status_desc->setDbValueDef($rsnew, $this->status_desc->CurrentValue, "", FALSE);
