...
/**
 * Table class for ticket_view2
 */
class ticket_view2 extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'ticket_view2';
		$this->TableName = 'ticket_view2';
		$this->TableType = 'VIEW';
		...
		// item_id
		$this->item_id = new DbField('ticket_view2', 'ticket_view2', 'x_item_id', 'item_id', '`item_id`', '`item_id`', 3, 11, -1, FALSE, '`item_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// SRN
		$this->SRN = new DbField('ticket_view2', 'ticket_view2', 'x_SRN', 'SRN', '`SRN`', '`SRN`', 200, 255, -1, FALSE, '`SRN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->SRN->Sortable = TRUE; // Allow sort
		$this->fields['SRN'] = &$this->SRN;

		// Request
		$this->__Request = new DbField('ticket_view2', 'ticket_view2', 'x___Request', 'Request', '`Request`', '`Request`', 3, 11, -1, FALSE, '`Request`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// month
		$this->month = new DbField('ticket_view2', 'ticket_view2', 'x_month', 'month', '`month`', '`month`', 3, 11, -1, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Year
		$this->Year = new DbField('ticket_view2', 'ticket_view2', 'x_Year', 'Year', '`Year`', '`Year`', 3, 11, -1, FALSE, '`EV__Year`', TRUE, TRUE, TRUE, 'FORMATTED TEXT', 'TEXT');
		...
		// item_date_receive
		$this->item_date_receive = new DbField('ticket_view2', 'ticket_view2', 'x_item_date_receive', 'item_date_receive', '`item_date_receive`', CastDateFieldForLike("`item_date_receive`", 5, "DB"), 133, 10, 5, FALSE, '`item_date_receive`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// item_date_repaired
		$this->item_date_repaired = new DbField('ticket_view2', 'ticket_view2', 'x_item_date_repaired', 'item_date_repaired', '`item_date_repaired`', CastDateFieldForLike("`item_date_repaired`", 1, "DB"), 133, 10, 1, FALSE, '`item_date_repaired`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// technician_name
		$this->technician_name = new DbField('ticket_view2', 'ticket_view2', 'x_technician_name', 'technician_name', '`technician_name`', '`technician_name`', 3, 50, -1, FALSE, '`technician_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// employeeid
		$this->employeeid = new DbField('ticket_view2', 'ticket_view2', 'x_employeeid', 'employeeid', '`employeeid`', '`employeeid`', 3, 11, -1, FALSE, '`employeeid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// item_requested_unit
		$this->item_requested_unit = new DbField('ticket_view2', 'ticket_view2', 'x_item_requested_unit', 'item_requested_unit', '`item_requested_unit`', '`item_requested_unit`', 3, 50, -1, FALSE, '`item_requested_unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// item_transmittal
		$this->item_transmittal = new DbField('ticket_view2', 'ticket_view2', 'x_item_transmittal', 'item_transmittal', '`item_transmittal`', '`item_transmittal`', 200, 100, -1, FALSE, '`item_transmittal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->item_transmittal->Sortable = TRUE; // Allow sort
		$this->fields['item_transmittal'] = &$this->item_transmittal;

		// position
		$this->position = new DbField('ticket_view2', 'ticket_view2', 'x_position', 'position', '`position`', '`position`', 200, 100, -1, FALSE, '`position`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->position->Sortable = TRUE; // Allow sort
		$this->fields['position'] = &$this->position;

		// Contact_no
		$this->Contact_no = new DbField('ticket_view2', 'ticket_view2', 'x_Contact_no', 'Contact_no', '`Contact_no`', '`Contact_no`', 3, 11, -1, FALSE, '`Contact_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// item_type
		$this->item_type = new DbField('ticket_view2', 'ticket_view2', 'x_item_type', 'item_type', '`item_type`', '`item_type`', 3, 50, -1, FALSE, '`item_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// item_model
		$this->item_model = new DbField('ticket_view2', 'ticket_view2', 'x_item_model', 'item_model', '`item_model`', '`item_model`', 200, 255, -1, FALSE, '`item_model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->item_model->Sortable = TRUE; // Allow sort
		$this->fields['item_model'] = &$this->item_model;

		// item_serno
		$this->item_serno = new DbField('ticket_view2', 'ticket_view2', 'x_item_serno', 'item_serno', '`item_serno`', '`item_serno`', 200, 255, -1, FALSE, '`item_serno`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->item_serno->Sortable = TRUE; // Allow sort
		$this->fields['item_serno'] = &$this->item_serno;

		// Region
		$this->Region = new DbField('ticket_view2', 'ticket_view2', 'x_Region', 'Region', '`Region`', '`Region`', 3, 11, -1, FALSE, '`Region`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Province
		$this->Province = new DbField('ticket_view2', 'ticket_view2', 'x_Province', 'Province', '`Province`', '`Province`', 3, 11, -1, FALSE, '`Province`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// Cities
		$this->Cities = new DbField('ticket_view2', 'ticket_view2', 'x_Cities', 'Cities', '`Cities`', '`Cities`', 3, 11, -1, FALSE, '`Cities`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// item_type_problem
		$this->item_type_problem = new DbField('ticket_view2', 'ticket_view2', 'x_item_type_problem', 'item_type_problem', '`item_type_problem`', '`item_type_problem`', 201, 500, -1, FALSE, '`item_type_problem`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->item_type_problem->Sortable = TRUE; // Allow sort
		$this->fields['item_type_problem'] = &$this->item_type_problem;

		// item_action_taken
		$this->item_action_taken = new DbField('ticket_view2', 'ticket_view2', 'x_item_action_taken', 'item_action_taken', '`item_action_taken`', '`item_action_taken`', 201, 500, -1, FALSE, '`item_action_taken`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->item_action_taken->Sortable = TRUE; // Allow sort
		$this->fields['item_action_taken'] = &$this->item_action_taken;

		// item_date_pullout
		$this->item_date_pullout = new DbField('ticket_view2', 'ticket_view2', 'x_item_date_pullout', 'item_date_pullout', '`item_date_pullout`', CastDateFieldForLike("`item_date_pullout`", 1, "DB"), 133, 10, 1, FALSE, '`item_date_pullout`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status_desc
		$this->status_desc = new DbField('ticket_view2', 'ticket_view2', 'x_status_desc', 'status_desc', '`status_desc`', '`status_desc`', 200, 100, -1, FALSE, '`status_desc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// remarks
		$this->remarks = new DbField('ticket_view2', 'ticket_view2', 'x_remarks', 'remarks', '`remarks`', '`remarks`', 201, 500, -1, FALSE, '`remarks`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	public function getSqlWhere() // Where
	{
		...
		$this->TableFilter = "`status_desc` = 'New Ticket'";
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "ticket_view2edit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ticket_view2add.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ticket_view2view.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ticket_view2view.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "ticket_view2add.php?" . $this->getUrlParm($parm);
		else
			$url = "ticket_view2add.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ticket_view2edit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ticket_view2add.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ticket_view2delete.php", $this->getUrlParm());
	}
	...
	{
			$this->status_desc->Count++; // Increment count
	}

	// Aggregate list row (for rendering)
	public function aggregateListRow()
	{
			$this->status_desc->CurrentValue = $this->status_desc->Count;
			$this->status_desc->ViewValue = $this->status_desc->CurrentValue;
			$this->status_desc->ViewCustomAttributes = "";
			$this->status_desc->HrefValue = ""; // Clear href value
	...
	public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
	{
		...
		if ($doc->Horizontal) {
			...
			if (!$doc->ExportCustom) {
				...
				$doc->exportAggregate($this->item_id, '');
				$doc->exportAggregate($this->SRN, '');
				$doc->exportAggregate($this->__Request, '');
				$doc->exportAggregate($this->month, '');
				$doc->exportAggregate($this->Year, '');
				$doc->exportAggregate($this->item_date_receive, '');
				$doc->exportAggregate($this->item_date_repaired, '');
				$doc->exportAggregate($this->technician_name, '');
				$doc->exportAggregate($this->item_requested_unit, '');
				$doc->exportAggregate($this->item_transmittal, '');
				$doc->exportAggregate($this->position, '');
				$doc->exportAggregate($this->Contact_no, '');
				$doc->exportAggregate($this->item_type, '');
				$doc->exportAggregate($this->item_model, '');
				$doc->exportAggregate($this->item_serno, '');
				$doc->exportAggregate($this->Region, '');
				$doc->exportAggregate($this->Province, '');
				$doc->exportAggregate($this->Cities, '');
				$doc->exportAggregate($this->item_type_problem, '');
				$doc->exportAggregate($this->item_action_taken, '');
				$doc->exportAggregate($this->item_date_pullout, '');
				$doc->exportAggregate($this->status_desc, 'COUNT');
