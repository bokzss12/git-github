 ...
 * Page class
 */
class tbl_printing_add extends tbl_printing
{
	...
	// Page object name
	public $PageObjName = "tbl_printing_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("printingID") !== NULL) {
				...
				$this->setKey("printingID", $this->printingID->CurrentValue); // Set up key
			} else {
				$this->setKey("printingID", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "tbl_printingview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->printingID->OldValue = $this->printingID->CurrentValue;
		$this->printing_month->CurrentValue = NULL;
		$this->printing_month->OldValue = $this->printing_month->CurrentValue;
		$this->printing_year->CurrentValue = NULL;
		$this->printing_year->OldValue = $this->printing_year->CurrentValue;
		$this->printing_date->CurrentValue = date("Y/m/d");
		$this->printing_type->CurrentValue = NULL;
		$this->printing_type->OldValue = $this->printing_type->CurrentValue;
		$this->printed_forms->CurrentValue = NULL;
		$this->printed_forms->OldValue = $this->printed_forms->CurrentValue;
		$this->total_forms->CurrentValue = NULL;
		$this->total_forms->OldValue = $this->total_forms->CurrentValue;
		$this->status_printing->CurrentValue = NULL;
		$this->status_printing->OldValue = $this->status_printing->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['printingID'] = $this->printingID->CurrentValue;
		$row['printing_month'] = $this->printing_month->CurrentValue;
		$row['printing_year'] = $this->printing_year->CurrentValue;
		$row['printing_date'] = $this->printing_date->CurrentValue;
		$row['printing_type'] = $this->printing_type->CurrentValue;
		$row['printed_forms'] = $this->printed_forms->CurrentValue;
		$row['total_forms'] = $this->total_forms->CurrentValue;
		$row['status_printing'] = $this->status_printing->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// printing_date
		$this->printing_date->setDbValueDef($rsnew, UnFormatDateTime($this->printing_date->CurrentValue, 5), NULL, FALSE);

		// printing_type
		$this->printing_type->setDbValueDef($rsnew, $this->printing_type->CurrentValue, NULL, FALSE);

		// printed_forms
		$this->printed_forms->setDbValueDef($rsnew, $this->printed_forms->CurrentValue, NULL, FALSE);

		// total_forms
		$this->total_forms->setDbValueDef($rsnew, $this->total_forms->CurrentValue, NULL, FALSE);

		// status_printing
		$this->status_printing->setDbValueDef($rsnew, $this->status_printing->CurrentValue, NULL, FALSE);
