 ...
 * Page class
 */
class tbl_borrowers_delete extends tbl_borrowers
{
	...
	// Page object name
	public $PageObjName = "tbl_borrowers_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_borrowerslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tbl_borrowerslist.php"); // Return to list
			}
		}
	}
