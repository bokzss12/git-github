 ...
 * Page class
 */
class Tecket_dashboard extends ReportTable
{
	...
	// Table name
	public $TableName = 'Tecket';

	// Page object name
	public $PageObjName = "Tecket_dashboard";
	...
	public function __construct()
	{
		...
		// Initialize
		$this->TableVar = 'Tecket';
		$this->TableName = 'Tecket';
		...
		if (!isset($GLOBALS['Encoder_Report_1']))
			$GLOBALS['Encoder_Report_1'] = new Encoder_Report_1();

		// Table object (Printing_Report_1)
		if (!isset($GLOBALS['Printing_Report_1']))
			$GLOBALS['Printing_Report_1'] = new Printing_Report_1();

		// Table object (Inventory_Report_1)
		if (!isset($GLOBALS['Inventory_Report_1']))
			$GLOBALS['Inventory_Report_1'] = new Inventory_Report_1();

		// Table object (Ticket_report)
		if (!isset($GLOBALS['Ticket_report']))
			$GLOBALS['Ticket_report'] = new Ticket_report();
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Tecket');
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'Tecket');
			if ($Security->isLoggedIn())
