 ...
 * Page class
 */
class lib_cities_delete extends lib_cities
{
	...
	// Page object name
	public $PageObjName = "lib_cities_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("lib_citieslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("lib_citieslist.php"); // Return to list
			}
		}
	}
