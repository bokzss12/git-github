...
class load
{
	...
	// Table name
	public $TableName = 'load.php';

	// Page object name
	public $PageObjName = "load";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'load.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "load", $url, "", "load", TRUE);
		$this->Heading = $Language->TablePhrase("load", "TblCaption"); 
	}
} // End class
?>