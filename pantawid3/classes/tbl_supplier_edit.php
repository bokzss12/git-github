 ...
 * Page class
 */
class tbl_supplier_edit extends tbl_supplier
{
	...
	// Page object name
	public $PageObjName = "tbl_supplier_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("supplierID") !== NULL) {
				...
				$this->supplierID->setQueryStringValue(Key(0));
				$this->supplierID->setOldValue($this->supplierID->QueryStringValue);
				...
				$this->supplierID->setQueryStringValue(Route(2));
				$this->supplierID->setOldValue($this->supplierID->QueryStringValue);
			} else {
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// supplier_dsc
			$this->supplier_dsc->setDbValueDef($rsnew, $this->supplier_dsc->CurrentValue, NULL, $this->supplier_dsc->ReadOnly);
