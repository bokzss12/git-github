...
/**
 * Table class for audittrailview
 */
class audittrailview extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'audittrailview';
		$this->TableName = 'audittrailview';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`audittrailview`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('audittrailview', 'audittrailview', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('audittrailview', 'audittrailview', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// script
		$this->script = new DbField('audittrailview', 'audittrailview', 'x_script', 'script', '`script`', '`script`', 200, 255, -1, FALSE, '`script`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->script->Sortable = TRUE; // Allow sort
		$this->fields['script'] = &$this->script;

		// Name_dsc
		$this->Name_dsc = new DbField('audittrailview', 'audittrailview', 'x_Name_dsc', 'Name_dsc', '`Name_dsc`', '`Name_dsc`', 200, 50, -1, FALSE, '`Name_dsc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name_dsc->Sortable = TRUE; // Allow sort
		$this->fields['Name_dsc'] = &$this->Name_dsc;

		// action
		$this->_action = new DbField('audittrailview', 'audittrailview', 'x__action', 'action', '`action`', '`action`', 200, 255, -1, FALSE, '`action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_action->Sortable = TRUE; // Allow sort
		$this->fields['action'] = &$this->_action;

		// table
		$this->_table = new DbField('audittrailview', 'audittrailview', 'x__table', 'table', '`table`', '`table`', 200, 255, -1, FALSE, '`table`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_table->Sortable = TRUE; // Allow sort
		$this->fields['table'] = &$this->_table;

		// field
		$this->field = new DbField('audittrailview', 'audittrailview', 'x_field', 'field', '`field`', '`field`', 200, 255, -1, FALSE, '`field`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field->Sortable = TRUE; // Allow sort
		$this->fields['field'] = &$this->field;

		// keyvalue
		$this->keyvalue = new DbField('audittrailview', 'audittrailview', 'x_keyvalue', 'keyvalue', '`keyvalue`', '`keyvalue`', 201, -1, -1, FALSE, '`keyvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keyvalue->Sortable = TRUE; // Allow sort
		$this->fields['keyvalue'] = &$this->keyvalue;

		// oldvalue
		$this->oldvalue = new DbField('audittrailview', 'audittrailview', 'x_oldvalue', 'oldvalue', '`oldvalue`', '`oldvalue`', 201, -1, -1, FALSE, '`oldvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->oldvalue->Sortable = TRUE; // Allow sort
		$this->fields['oldvalue'] = &$this->oldvalue;

		// newvalue
		$this->newvalue = new DbField('audittrailview', 'audittrailview', 'x_newvalue', 'newvalue', '`newvalue`', '`newvalue`', 201, -1, -1, FALSE, '`newvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`audittrailview`";
	}
	...
	{
		global $Language;
		if ($pageName == "audittrailviewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "audittrailviewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "audittrailviewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("audittrailviewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("audittrailviewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "audittrailviewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "audittrailviewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("audittrailviewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("audittrailviewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("audittrailviewdelete.php", $this->getUrlParm());
	}
