 ...
 * Page class
 */
class tbl_spec_delete extends tbl_spec
{
	...
	// Page object name
	public $PageObjName = "tbl_spec_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_speclist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tbl_speclist.php"); // Return to list
			}
		}
	}
