 ...
 * Page class
 */
class tbl_month_delete extends tbl_month
{
	...
	// Page object name
	public $PageObjName = "tbl_month_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_monthlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tbl_monthlist.php"); // Return to list
			}
		}
	}
