 ...
 * Page class
 */
class tbl_item_status_view extends tbl_item_status
{
	...
	// Page object name
	public $PageObjName = "tbl_item_status_view";
	...
	public function __construct()
	{
		...
		if (Get("status_id") !== NULL) {
			$this->RecKey["status_id"] = Get("status_id");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("status_id") !== NULL) {
				...
				$this->status_id->setFormValue(Route(2));
				$this->RecKey["status_id"] = $this->status_id->FormValue;
			} else {
				$returnUrl = "tbl_item_statuslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_item_statuslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tbl_item_statuslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
