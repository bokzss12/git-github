...
class Import
{
	...
	// Table name
	public $TableName = 'Import.php';

	// Page object name
	public $PageObjName = "Import";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Import.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "Import", $url, "", "Import", TRUE);
		$this->Heading = $Language->TablePhrase("Import", "TblCaption"); 
	}
} // End class
?>