...
/**
 * Table class for tbl_item_status
 */
class tbl_item_status extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'tbl_item_status';
		$this->TableName = 'tbl_item_status';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`tbl_item_status`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// status_id
		$this->status_id = new DbField('tbl_item_status', 'tbl_item_status', 'x_status_id', 'status_id', '`status_id`', '`status_id`', 3, 11, -1, FALSE, '`status_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// status_desc
		$this->status_desc = new DbField('tbl_item_status', 'tbl_item_status', 'x_status_desc', 'status_desc', '`status_desc`', '`status_desc`', 200, 100, -1, FALSE, '`status_desc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status_desc->Nullable = FALSE; // NOT NULL field
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`tbl_item_status`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "tbl_item_statuslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "tbl_item_statusview.php")
			return $Language->phrase("View");
		elseif ($pageName == "tbl_item_statusedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "tbl_item_statusadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("tbl_item_statusview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("tbl_item_statusview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "tbl_item_statusadd.php?" . $this->getUrlParm($parm);
		else
			$url = "tbl_item_statusadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_item_statusedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("tbl_item_statusadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("tbl_item_statusdelete.php", $this->getUrlParm());
	}
	...
	public function keyUrl($url, $parm = "")
	{
		...
		if ($this->status_id->CurrentValue != NULL) {
			$url .= "status_id=" . urlencode($this->status_id->CurrentValue);
		} else {
