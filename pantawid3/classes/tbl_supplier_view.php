 ...
 * Page class
 */
class tbl_supplier_view extends tbl_supplier
{
	...
	// Page object name
	public $PageObjName = "tbl_supplier_view";
	...
	public function __construct()
	{
		...
		if (Get("supplierID") !== NULL) {
			$this->RecKey["supplierID"] = Get("supplierID");
			$keyUrl .= "&amp;supplierID=" . urlencode($this->RecKey["supplierID"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("supplierID") !== NULL) {
				...
				$this->supplierID->setFormValue(Route(2));
				$this->RecKey["supplierID"] = $this->supplierID->FormValue;
			} else {
				$returnUrl = "tbl_supplierlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_supplierlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tbl_supplierlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
