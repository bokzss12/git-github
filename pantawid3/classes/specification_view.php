...
/**
 * Table class for specification_view
 */
class specification_view extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'specification_view';
		$this->TableName = 'specification_view';
		$this->TableType = 'VIEW';
		...
		// pr_number
		$this->pr_number = new DbField('specification_view', 'specification_view', 'x_pr_number', 'pr_number', '`pr_number`', '`pr_number`', 200, 100, -1, FALSE, '`pr_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pr_number->Sortable = TRUE; // Allow sort
		$this->fields['pr_number'] = &$this->pr_number;

		// spec_unit
		$this->spec_unit = new DbField('specification_view', 'specification_view', 'x_spec_unit', 'spec_unit', '`spec_unit`', '`spec_unit`', 3, 11, -1, FALSE, '`spec_unit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// spec_dsc
		$this->spec_dsc = new DbField('specification_view', 'specification_view', 'x_spec_dsc', 'spec_dsc', '`spec_dsc`', '`spec_dsc`', 200, 100, -1, FALSE, '`spec_dsc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->spec_dsc->Sortable = TRUE; // Allow sort
		$this->fields['spec_dsc'] = &$this->spec_dsc;

		// spec_qty
		$this->spec_qty = new DbField('specification_view', 'specification_view', 'x_spec_qty', 'spec_qty', '`spec_qty`', '`spec_qty`', 131, 50, -1, FALSE, '`spec_qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spec_unitprice
		$this->spec_unitprice = new DbField('specification_view', 'specification_view', 'x_spec_unitprice', 'spec_unitprice', '`spec_unitprice`', '`spec_unitprice`', 131, 50, -1, FALSE, '`spec_unitprice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// spec_totalprice
		$this->spec_totalprice = new DbField('specification_view', 'specification_view', 'x_spec_totalprice', 'spec_totalprice', '`spec_totalprice`', '`spec_totalprice`', 131, 50, -1, FALSE, '`spec_totalprice`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// employeeID
		$this->employeeID = new DbField('specification_view', 'specification_view', 'x_employeeID', 'employeeID', '`employeeID`', '`employeeID`', 3, 11, -1, FALSE, '`employeeID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->employeeID->Sortable = FALSE; // Allow sort
		$this->employeeID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['employeeID'] = &$this->employeeID;

		// user_last_modify
		$this->user_last_modify = new DbField('specification_view', 'specification_view', 'x_user_last_modify', 'user_last_modify', '`user_last_modify`', '`user_last_modify`', 200, 50, -1, FALSE, '`user_last_modify`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_last_modify->Sortable = TRUE; // Allow sort
		$this->fields['user_last_modify'] = &$this->user_last_modify;

		// date_last_modify
		$this->date_last_modify = new DbField('specification_view', 'specification_view', 'x_date_last_modify', 'date_last_modify', '`date_last_modify`', CastDateFieldForLike("`date_last_modify`", 0, "DB"), 135, 19, 0, FALSE, '`date_last_modify`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// specID
		$this->specID = new DbField('specification_view', 'specification_view', 'x_specID', 'specID', '`specID`', '`specID`', 3, 11, -1, FALSE, '`specID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`specification_view`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "specification_viewlist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "specification_viewview.php")
			return $Language->phrase("View");
		elseif ($pageName == "specification_viewedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "specification_viewadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("specification_viewview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("specification_viewview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "specification_viewadd.php?" . $this->getUrlParm($parm);
		else
			$url = "specification_viewadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("specification_viewedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("specification_viewadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("specification_viewdelete.php", $this->getUrlParm());
	}
