 ...
 * Page class
 */
class ticket_view2_list extends ticket_view2
{
	...
	// Page object name
	public $PageObjName = "ticket_view2_list";

	// Grid form hidden field names
	public $FormName = "fticket_view2list";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "ticket_view2add.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "ticket_view2delete.php";
		$this->MultiUpdateUrl = "ticket_view2update.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fticket_view2listsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fticket_view2listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fticket_view2listsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fticket_view2list}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->status_desc->Count = 0; // Initialize count
	...
	$item->Body = "<a class=\"ewAction\" href=\"ticketadd.php\" > Add Ticket </a>";
	} */
