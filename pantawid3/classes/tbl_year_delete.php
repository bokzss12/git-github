 ...
 * Page class
 */
class tbl_year_delete extends tbl_year
{
	...
	// Page object name
	public $PageObjName = "tbl_year_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tbl_yearlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("tbl_yearlist.php"); // Return to list
			}
		}
	}
