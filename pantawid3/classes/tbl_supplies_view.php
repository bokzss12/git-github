 ...
 * Page class
 */
class tbl_supplies_view extends tbl_supplies
{
	...
	// Page object name
	public $PageObjName = "tbl_supplies_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tbl_supplieslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tbl_supplieslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tbl_supplieslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
