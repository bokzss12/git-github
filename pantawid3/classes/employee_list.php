...
class employee_list extends employee
{
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->userlevel_id, $arKeywords, $type);
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			if ($this->photo->UseColorbox) {
				...
				$this->photo->LinkAttrs["data-rel"] = "employee_x" . $this->RowCount . "_photo";
	...
	function ListOptions_Rendered() {
		...
		//$this->ListOptions->Items["new"]->Body = "xxx";
					...
					$this->ListOptions->Items["view"]->Body = "<a href=employeeview.php?showdetail=&employeeid=".$this->employeeid->CurrentValue."><img src='phpimages/view.gif' border='0'></a>";
					$this->ListOptions->Items["edit"]->Body = "<a href=employeeedit.php?employeeid=".$this->employeeid->CurrentValue."><img src='phpimages/edit.gif' border='0'></a>";
					$this->ListOptions->Items["delete"]->Body = "<a href=employeedelete.php?employeeid=".$this->employeeid->CurrentValue."><img src='phpimages/delete.gif' border='0'></a>";
	}
