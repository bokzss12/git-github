 ...
 * Page class
 */
class lib_regions_view extends lib_regions
{
	...
	// Page object name
	public $PageObjName = "lib_regions_view";
	...
	public function __construct()
	{
		...
		if (Get("region_code") !== NULL) {
			$this->RecKey["region_code"] = Get("region_code");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("region_code") !== NULL) {
				...
				$this->RecKey["region_code"] = $this->region_code->FormValue;
			} elseif (IsApi() && Route(2) !== NULL) {
				$this->region_code->setFormValue(Route(2));
				$this->RecKey["region_code"] = $this->region_code->FormValue;
			} else {
				$returnUrl = "lib_regionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "lib_regionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "lib_regionslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
