...
class userlevels_list extends userlevels
{
	...
	function ListOptions_Rendered() {
		...
		//$this->ListOptions->Items["new"]->Body = "xxx";
					...
					$this->ListOptions->Items["view"]->Body = "<a href=userlevelsview.php?showdetail=&userlevelid=".$this->userlevelid->CurrentValue."><img src='phpimages/view.gif' border='0'></a>";
					$this->ListOptions->Items["edit"]->Body = "<a href=userlevelsedit.php?userlevelid=".$this->userlevelid->CurrentValue."><img src='phpimages/edit.gif' border='0'></a>";
					$this->ListOptions->Items["delete"]->Body = "<a href=userlevelsdelete.php?userlevelid=".$this->userlevelid->CurrentValue."><img src='phpimages/delete.gif' border='0'></a>";
	}
