 ...
 * Page class
 */
class specification_view_search extends specification_view
{
	...
	// Page object name
	public $PageObjName = "specification_view_search";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canSearch()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("specification_viewlist.php"));
				else
		...
		$this->spec_unit->Visible = FALSE;
		$this->spec_dsc->setVisibility();
		$this->spec_qty->Visible = FALSE;
		$this->spec_unitprice->Visible = FALSE;
		$this->spec_totalprice->Visible = FALSE;
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if ($this->isSearch()) {
				...
				if ($srchStr != "") {
					...
					$srchStr = "specification_viewlist.php" . "?" . $srchStr;
	...
	{
		$srchUrl = "";
		$this->buildSearchUrl($srchUrl, $this->pr_number); // pr_number
		$this->buildSearchUrl($srchUrl, $this->spec_dsc); // spec_dsc
		if ($srchUrl != "")
			$srchUrl .= "&";
		$srchUrl .= "cmd=search";
		return $srchUrl;
	...
	protected function loadSearchValues()
	{
		...
		// Load search values
		$got = FALSE;
		if ($this->pr_number->AdvancedSearch->post())
			$got = TRUE;
		if ($this->spec_dsc->AdvancedSearch->post())
			$got = TRUE;
		return $got;
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->spec_dsc->EditValue = HtmlEncode($this->spec_dsc->AdvancedSearch->SearchValue);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("specification_viewlist.php"), "", $this->TableVar, TRUE);
		$pageId = "search";
