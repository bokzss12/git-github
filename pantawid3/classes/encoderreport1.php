...
/**
 * Table class for encoderreport1
 */
class encoderreport1 extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'encoderreport1';
		$this->TableName = 'encoderreport1';
		$this->TableType = 'VIEW';
		...
		// encoder_id
		$this->encoder_id = new DbField('encoderreport1', 'encoderreport1', 'x_encoder_id', 'encoder_id', '`encoder_id`', '`encoder_id`', 3, 11, -1, FALSE, '`encoder_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// date
		$this->date = new DbField('encoderreport1', 'encoderreport1', 'x_date', 'date', '`date`', CastDateFieldForLike("`date`", 2, "DB"), 133, 10, 2, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// action_taken
		$this->action_taken = new DbField('encoderreport1', 'encoderreport1', 'x_action_taken', 'action_taken', '`action_taken`', '`action_taken`', 201, 500, -1, FALSE, '`action_taken`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		...
		// total_encoded
		$this->total_encoded = new DbField('encoderreport1', 'encoderreport1', 'x_total_encoded', 'total_encoded', '`total_encoded`', '`total_encoded`', 131, 50, -1, FALSE, '`total_encoded`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_encoded->Required = TRUE; // Required field
		...
		// year_dsc
		$this->year_dsc = new DbField('encoderreport1', 'encoderreport1', 'x_year_dsc', 'year_dsc', '`year_dsc`', '`year_dsc`', 200, 50, -1, FALSE, '`year_dsc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->year_dsc->Sortable = TRUE; // Allow sort
		$this->fields['year_dsc'] = &$this->year_dsc;

		// month_dsc
		$this->month_dsc = new DbField('encoderreport1', 'encoderreport1', 'x_month_dsc', 'month_dsc', '`month_dsc`', '`month_dsc`', 200, 50, -1, FALSE, '`month_dsc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->month_dsc->Sortable = TRUE; // Allow sort
		$this->fields['month_dsc'] = &$this->month_dsc;

		// status_remark1
		$this->status_remark1 = new DbField('encoderreport1', 'encoderreport1', 'x_status_remark1', 'status_remark1', '`status_remark1`', '`status_remark1`', 200, 50, -1, FALSE, '`status_remark1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status_remark1->Sortable = TRUE; // Allow sort
		$this->fields['status_remark1'] = &$this->status_remark1;

		// Name_dsc
		$this->Name_dsc = new DbField('encoderreport1', 'encoderreport1', 'x_Name_dsc', 'Name_dsc', '`Name_dsc`', '`Name_dsc`', 200, 50, -1, FALSE, '`Name_dsc`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Name_dsc->Sortable = TRUE; // Allow sort
		$this->fields['Name_dsc'] = &$this->Name_dsc;

		// List_Activities
		$this->List_Activities = new DbField('encoderreport1', 'encoderreport1', 'x_List_Activities', 'List_Activities', '`List_Activities`', '`List_Activities`', 200, 50, -1, FALSE, '`List_Activities`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->List_Activities->Sortable = TRUE; // Allow sort
		$this->fields['List_Activities'] = &$this->List_Activities;

		// employeeid
		$this->employeeid = new DbField('encoderreport1', 'encoderreport1', 'x_employeeid', 'employeeid', '`employeeid`', '`employeeid`', 3, 11, -1, FALSE, '`employeeid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->status_remark1->DbValue = $row['status_remark1'];
		$this->Name_dsc->DbValue = $row['Name_dsc'];
		$this->List_Activities->DbValue = $row['List_Activities'];
	...
	{
		global $Language;
		if ($pageName == "encoderreport1view.php")
			return $Language->phrase("View");
		elseif ($pageName == "encoderreport1edit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "encoderreport1add.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("encoderreport1view.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("encoderreport1view.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "encoderreport1add.php?" . $this->getUrlParm($parm);
		else
			$url = "encoderreport1add.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("encoderreport1edit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("encoderreport1add.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("encoderreport1delete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->status_remark1->setDbValue($rs->fields('status_remark1'));
		$this->Name_dsc->setDbValue($rs->fields('Name_dsc'));
		$this->List_Activities->setDbValue($rs->fields('List_Activities'));
	...
	public function renderEditRow()
	{
		...
		$this->date->EditValue = FormatDateTime($this->date->CurrentValue, 2);
		...
		if (strval($this->total_encoded->EditValue) != "" && is_numeric($this->total_encoded->EditValue))
			$this->total_encoded->EditValue = FormatNumber($this->total_encoded->EditValue, -2, -1, -2, 0);
		...
		// status_remark1
		$this->status_remark1->EditAttrs["class"] = "form-control";
		$this->status_remark1->EditCustomAttributes = "";
		if (!$this->status_remark1->Raw)
			$this->status_remark1->CurrentValue = HtmlDecode($this->status_remark1->CurrentValue);
		$this->status_remark1->EditValue = $this->status_remark1->CurrentValue;
		$this->status_remark1->PlaceHolder = RemoveHtml($this->status_remark1->caption());
		...
		$this->List_Activities->EditValue = $this->List_Activities->CurrentValue;
	...
	public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
	{
		...
		if (!$doc->ExportCustom) {
			...
			if ($doc->Horizontal) { // Horizontal format, write header
				...
				if ($exportPageType == "view") {
					...
					$doc->exportCaption($this->status_remark1);
					$doc->exportCaption($this->Name_dsc);
					$doc->exportCaption($this->List_Activities);
			...
			if ($recCnt >= $startRec) {
				...
				if (!$doc->ExportCustom) {
					...
					if ($exportPageType == "view") {
						...
						$doc->exportField($this->status_remark1);
						$doc->exportField($this->Name_dsc);
						$doc->exportField($this->List_Activities);
		...
		if ($doc->Horizontal) {
			...
			if (!$doc->ExportCustom) {
				...
				$doc->exportAggregate($this->status_remark1, '');
				$doc->exportAggregate($this->Name_dsc, '');
				$doc->exportAggregate($this->List_Activities, '');
