 ...
 * Page class
 */
class inventory_view_list extends inventory_view
{
	...
	// Page object name
	public $PageObjName = "inventory_view_list";

	// Grid form hidden field names
	public $FormName = "finventory_viewlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "inventory_viewadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "inventory_viewdelete.php";
		$this->MultiUpdateUrl = "inventory_viewupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option finventory_viewlistsrch";
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "finventory_viewlistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"finventory_viewlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"finventory_viewlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.finventory_viewlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"finventory_viewlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
	...
	function ListOptions_Rendered() {
		...
		//$this->ListOptions->Items["new"]->Body = "xxx";
		    ...
		    $this->ListOptions->Items["view"]->Body = "<a href=inventory_viewview.php?showdetail=&inventory_id=".$this->inventory_id->CurrentValue."><img src='phpimages/view.gif' border='0'></a>";
			$this->ListOptions->Items["edit"]->Body = "<a href=inventory_viewedit.php?inventory_id=".$this->inventory_id->CurrentValue."><img src='phpimages/edit.gif' border='0'></a>";
	  ...
	  //	$this->ListOptions->Items["delete"]->Body = "<a href=tbl_inventorydelete.php?inventory_id=".$this->inventory_id->CurrentValue."><img src='phpimages/delete.gif' border='0'></a>";
		...
		/*get status value from current record: -
		if statement remove edit button base on contion per Fields */
	$tmpRowstatus=$GLOBALS["inventory_view"]->status->CurrentValue;
	if ($tmpRowstatus!=("1")) {
