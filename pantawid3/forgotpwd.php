...
<p class="login-box-msg"><?php echo $Language->phrase("ResetPwdMsg") ?></p>
	<div class="form-group row">
		<input type="text" name="email" id="email" class="form-control ew-control" value="<?php echo HtmlEncode($forgotpwd->Email) ?>" size="20" maxlength="20" placeholder="<?php echo HtmlEncode($Language->phrase("UserEmail")) ?>">
	</div>
