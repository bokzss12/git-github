...
ew.ready("jquery", "<?php echo $RELATIVE_PATH ?>jquery/jsviews.min.js", "jsrender", ew.renderJsTemplates);
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>dswd.ico">
<link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>dswd.ico">
