...
loadjs.ready("load", function() {
	...
	// Startup script
	$("body").addClass("sidebar-collapse"),$(".content-wrapper").css({"background-image":"url(phpimages/login.jpg)","background-attachment":"fixed","background-size":"100%"}),$("#username").parent().addClass("input-group"),$("#username").parent().append('<span class="input-group-addon"><i class="fa fa-envelope"></i></span>'),$("#password").parent().addClass("input-group"),$("#password").parent().append('<span class="input-group-addon"><i class="fa fa-key"></i></span>'),$("#btnsubmit").addClass("btn-block");var header='<div class="login-logo"><span class="logo-lg"><img src="phpimages/dswd.png" style="height:130px;max-width:350px;"/></span></div>';$('[class="login-box ewLoginBox"]').prepend(header),$('[class="login-box ewLoginBox"]').addClass("panel panel-success");
});
</script>
