...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "pantawid2020"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '5fWzmsFt8a4r6y24', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/pantawid2020.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{90E1F5A3-D649-4B17-9FD2-DCF249C755E1}", // Project ID (GUID)
	...
	"BODY_CLASS" => "hold-transition layout-footer-fixed",
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "dswd"]
	],
	...
	"SESSION_TIMEOUT" => 60, // Session timeout time (minutes)
	...
	"ADMIN_PASSWORD" => "Racyjedo2k10", // Administrator password
	...
	"USER_LEVEL_FIELD_NAME" => "userlevel_id",
	"USER_PROFILE_FIELD_NAME" => "",
	"REGISTER_ACTIVATE_FIELD_NAME" => "activation",
	...
	"USER_ACTIVATE_FILTER" => "(`activation` = 1)",
	...
	"USER_PROFILE_SESSION_TIMEOUT" => 1,
	...
	"SENDER_EMAIL" => "randy12@gmail.com", // Sender email address
	"RECIPIENT_EMAIL" => "randy12@gmail.com", // Recipient email address
	...
	"THUMBNAIL_DEFAULT_HEIGHT" => 100, // Thumbnail default height
	...
	"IMPORT_MAX_EXECUTION_TIME" => 5000, // Import max execution time
	"IMPORT_FILE_ALLOWED_EXT" => "csv", // Import file allowed extensions
	...
	*/
	...
	"CHART_SHOW_ZERO_IN_STACK_CHART" => TRUE, // Show zero in stack chart
...
$CONFIG["PDF_MEMORY_LIMIT"] = "128"; // Memory limit
