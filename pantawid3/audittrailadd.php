...
<input type="text" data-table="audittrail" data-field="x_script" name="x_script" id="x_script" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($audittrail_add->script->getPlaceHolder()) ?>" value="<?php echo $audittrail_add->script->EditValue ?>"<?php echo $audittrail_add->script->editAttributes() ?>>
</span>
...
<input type="text" data-table="audittrail" data-field="x_user" name="x_user" id="x_user" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($audittrail_add->user->getPlaceHolder()) ?>" value="<?php echo $audittrail_add->user->EditValue ?>"<?php echo $audittrail_add->user->editAttributes() ?>>
</span>
...
<input type="text" data-table="audittrail" data-field="x__action" name="x__action" id="x__action" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($audittrail_add->_action->getPlaceHolder()) ?>" value="<?php echo $audittrail_add->_action->EditValue ?>"<?php echo $audittrail_add->_action->editAttributes() ?>>
</span>
...
<input type="text" data-table="audittrail" data-field="x__table" name="x__table" id="x__table" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($audittrail_add->_table->getPlaceHolder()) ?>" value="<?php echo $audittrail_add->_table->EditValue ?>"<?php echo $audittrail_add->_table->editAttributes() ?>>
</span>
...
<input type="text" data-table="audittrail" data-field="x_field" name="x_field" id="x_field" size="30" maxlength="255" placeholder="<?php echo HtmlEncode($audittrail_add->field->getPlaceHolder()) ?>" value="<?php echo $audittrail_add->field->EditValue ?>"<?php echo $audittrail_add->field->editAttributes() ?>>
</span>
